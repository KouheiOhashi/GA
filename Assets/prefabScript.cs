...
public class prefabScript : MonoBehaviour {
    ...
    float frequency = 0.35F;         //関節を動かす細かさ
    static int creatureNumber = 201;  //個体数は奇数
    bool one = false;
    int k=10;
    int limitTime = 10;              //limitTimeごとに世代交代
    int lowerLimit = -30;            //関節の角度の下限
    int upperLimit = 30;             //関節の角度の上限
    static int angleNumber = 8;      //関節の数
    static int step = 4;             //step数で運動の一周期
